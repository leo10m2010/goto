...
var messages = {
  _default: function (field) { return ("El " + field + " no es un valor valido"); },
  alpha_dash: function (field) { return ("El " + field + " field may contain alpha-numeric characters as well as dashes and underscores."); },
  alpha_num: function (field) { return ("El " + field + " field may only contain alpha-numeric characters."); },
  alpha_spaces: function (field) { return ("El " + field + " field may only contain alphabetic characters as well as spaces."); },
  alpha: function (field) { return ("El " + field + " field may only contain alphabetic characters."); },
  ...
  email: function (field) { return ("El campo " + field + " es incorrecto, debe ingresar un email valido"); },
